...
static PyMethodDef __pyx_mdef_9animation_1Animate = {"Animate", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9animation_1Animate, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9animation_1Animate(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_Current,&__pyx_mstate_global->__pyx_n_u_Target,&__pyx_mstate_global->__pyx_n_u_Speed,&__pyx_mstate_global->__pyx_n_u_AO,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "Animate", 0) < 0) __PYX_ERR(0, 2, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 4; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("Animate", 1, 4, 4, i); __PYX_ERR(0, 2, __pyx_L3_error) }
      }
...
static PyObject *__pyx_pf_9animation_Animate(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_Current, float __pyx_v_Target, float __pyx_v_Speed, float __pyx_v_AO) {
  ...
  __pyx_t_1 = __pyx_f_9animation_Animate(__pyx_v_Current, __pyx_v_Target, __pyx_v_Speed, __pyx_v_AO, 1); if (unlikely(__pyx_t_1 == ((float)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L1_error)
...
static PyMethodDef __pyx_mdef_9animation_3AnimateSpdUp = {"AnimateSpdUp", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9animation_3AnimateSpdUp, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9animation_3AnimateSpdUp(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "AnimateSpdUp", 0) < 0) __PYX_ERR(0, 10, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 6; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("AnimateSpdUp", 1, 6, 6, i); __PYX_ERR(0, 10, __pyx_L3_error) }
      }
...
static PyObject *__pyx_pf_9animation_2AnimateSpdUp(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_Negative, float __pyx_v_Current, float __pyx_v_Start, float __pyx_v_Target, float __pyx_v_Speed, float __pyx_v_AO) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("AnimateSpdUp", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_9animation_AnimateSpdUp(__pyx_v_Negative, __pyx_v_Current, __pyx_v_Start, __pyx_v_Target, __pyx_v_Speed, __pyx_v_AO, 1); if (unlikely(__pyx_t_1 == ((float)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L1_error)
...
__Pyx_RefNannySetupContext("PyInit_animation", 0);
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_Animate, __pyx_t_2) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 *     if Current == Target:
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9animation_3AnimateSpdUp, 0, __pyx_mstate_global->__pyx_n_u_AnimateSpdUp, NULL, __pyx_mstate_global->__pyx_n_u_animation, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_optimization_animation_pyx, sizeof(__pyx_k_optimization_animation_pyx), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_optimization_animation_pyx */
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {4, 0, 0, 4, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 2, 48};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_Current, __pyx_mstate->__pyx_n_u_Target, __pyx_mstate->__pyx_n_u_Speed, __pyx_mstate->__pyx_n_u_AO};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_optimization_animation_pyx, __pyx_mstate->__pyx_n_u_Animate, __pyx_k_1_s_82XRq_q_xs_9Bc_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
